...
if flag.TRAIN:
    new_trainer=Trainer(num_training_steps=20000,num_env=12,num_game_steps=128,num_epoch=1,learning_rate=0.0002
                        ,discount_factor=0.99,env=env,num_action=5,clip_range=0.1,value_coef=0,save_interval=50,
                        log_interval=10,
