...
if flag.TRAIN:
    new_trainer=Trainer(num_training_steps=20000,num_env=4,num_game_steps=16,num_epoch=3,learning_rate=0.001
                        ,discount_factor=0.99,env=env,num_action=5,clip_range=0.1,value_coef=0.5,save_interval=50,
                        log_interval=10,
                        entropy_coef=0.0,lam=0.99,mini_batch_size=16,num_action_repeat=1)
