...
if flag.TRAIN:
    new_trainer = Trainer(num_training_steps=20000, num_env=6, num_game_steps=32, num_epoch=4, learning_rate=2e-4
                          , discount_factor=0.99, num_action=5, clip_range=0.2, value_coef=0.5,
                          save_interval=20,
                          log_interval=10,
                          entropy_coef=0.05, lam=0.95, mini_batch_size=32*6, num_action_repeat=1)
