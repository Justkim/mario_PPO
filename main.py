...
new_trainer=Trainer(num_training_steps=1000,num_game_steps=4,num_epoch=3,batch_size=4,learning_rate=0.01,discount_factor=0.99,env=env,num_action=3,clip_range=0.1,value_coef=0.5,save_interval=20,entropy_coef=0.01,lam=0.95)
