...
if flag.TRAIN:
    ...
    new_trainer=Trainer(num_training_steps=20000,num_game_steps=8,num_epoch=4,batch_size=4,learning_rate=0.00045
                        ,discount_factor=0.99,env=env,num_action=7,clip_range=0.2,value_coef=0.5,save_interval=50,
                        entropy_coef=0.0001,lam=0.95)
