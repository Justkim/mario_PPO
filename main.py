...
new_trainer=Trainer(num_training_steps=1000,num_game_steps=1,num_epoch=1,batch_size=1,learning_rate=0.01,discount_factor=0.99,env=env,num_action=3,clip_range=0.1,value_coef=0.5)
