...
new_trainer=Trainer(num_training_steps=1000,num_game_steps=4,num_epoch=2,batch_size=1,learning_rate=0.00025,discount_factor=0.99,env=env,num_action=3,clip_range=0.2,value_coef=0.5,save_interval=20,entropy_coef=0.001,lam=0.95)
